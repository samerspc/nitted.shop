    ...
    <section className={styles.wrapper}>
      ...
      <aside className={styles.aside}>
        {brands.map((item, i) => (
          <button
            key={i}
            className={styles.brand_button + (selectedBrand === item ? ' ' + styles.active : '')}
            ...
            <div className={styles.sorts_wrapper_options_sorts}>
              {sortOptions.map((option) => (
                <div
                  ...
                  style={{
                    fontWeight: selectedSort.value === option.value ? 'bold' : undefined,
                  }}
            ...
            <div className={styles.sorts_wrapper_options_size}>
              {sizes.sizesEu.map((size) => (
                <div
                  ...
                  style={{
                    fontWeight: selectedSize === `${size}EU` ? 'bold' : undefined,
                  }}
              ...
              {sizes.sizesUs.map((size) => (
                <div
                  ...
                  style={{
                    fontWeight: selectedSize === `${size}US` ? 'bold' : undefined,
                  }}
                  className={styles.sorts_wrapper_options_size__item}
                >
                  {size}US
              ...
              {sizes.sizesMm.map((size) => (
                <div
                  ...
                  style={{
                    fontWeight: selectedSize === `${size}MM` ? 'bold' : undefined,
                  }}
                  className={styles.sorts_wrapper_options_size__item}
                >
                  {size}MM
