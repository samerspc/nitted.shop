  ...
  if (quickBuyProduct) {
    return (
      <div className={styles.cartPopupOverlay} onClick={handleClose}>
        {isMobile && (
          <p onClick={handleClose} className={styles.mobileClose}>
            Закрыть
          </p>
        )}
              ...
              <>
                ...
                <form className={styles.orderForm} onSubmit={(e) => handleOrderSubmit(e, true)}>
                  ...
                  <label className={styles.checkboxLabel}>
                    <input type="checkbox" name="privacy" required className={styles.checkbox} />Я
                  ...
                  <button type="submit" className={styles.makeOrder}>
                    Создать заявку
                  </button>
                </form>
              </>
