                ...
                <>
                    { isMobileMenuOpen &&
                        <div
                            ...
                            className={styles.mobileMenuPopUp_layout}>
                            <div className={styles.mobileMenuPopUp_menu}>
                                <Link to='/catalog/male' className={styles.mobileMenuPopUp_menu_link}>Поиск</Link>
                                <Link to='/catalog/male' className={styles.mobileMenuPopUp_menu_link}>Мужское</Link>
                                <Link to='/catalog/female' className={styles.mobileMenuPopUp_menu_link}>Женское</Link>
                            </div>
                        </div>       
                    }
                    <header className={`${styles.wrapper} 
                        ...
                        { isMobileMenuOpen ?
                            ...
                            <Link to="/" className={`${ isMobileMenuOpen ? styles.logoMenuOpen : styles.logo} crimson-text-regular`}>
                                nitted.
                            </Link>
